...
<html lang="en">
  <head>
    ...
    <title>MMA Waterford - Booking Created</title>
  ...
  <body role="document">
	...
	<div class="panel panel-default">
		...
		$sql="INSERT INTO bookings (class_id, user_id)
		VALUES('$_REQUEST[selectClass]','$userID')";

		if ($conn->query($sql) === TRUE) {
			echo "Booking created successfully. <a href='Bookings.php'>View your bookings.</a>";
		} else {
