...
<html lang="en">
  <head>
    ...
    <title>MAA Waterford - Delete Booking</title>
...
<?php include 'nav.php'; ?>
	...
	<div class="panel panel-default">
	  ...
	  <?php
		...
		?>
		<p>Please confirm that you wish to delete the following booking: <br></p>
		<form class="query-form" action="bookingDeleted.php" name="queryForm" method="post">
		<label for="bookingID">Booking ID:</label>
		<input type="text" name="bookingID" class="form-control" placeholder="<?php echo $bookingID; ?>" readonly>
		
		<br>
		
		<label for="oldClass">Class Selected:</label>
		...
		{
			echo "<input type='text' name='oldClass' class='form-control' placeholder='";
			echo $row['Class'] . ", " . $row['Day'] . ", " .
			$row['Time'] .", Coach: " . $row['Coach'];
			echo "' readonly> <br>";
		}
		?>
