...
<html lang="en">
  <head>
    ...
    <title>MMA Waterford - Thank you</title>
...
<?php 
include 'connect.php';
$sql = "INSERT INTO queries(Firstname, Lastname, Email, Query)
		VALUES('$_POST[FirstName]','$_POST[LastName]','$_POST[Email]','$_POST[Query]')";
		
		if ($conn->query($sql) === TRUE) {
			echo "<h2> Thank you for your query</h2></br>
					<h3> We will get back to you as soon as possible</h3></br>";
		} else {
		...
		?>
		<p>Confirmation - here are the details you have entered:</p>
		<p>
		First Name: <?php echo $_REQUEST["FirstName"]; ?><br />
		Last Name: <?php echo $_REQUEST["LastName"]; ?></br />
		Email: <?php echo $_REQUEST["Email"]; ?><br />
		Query: <?php echo $_REQUEST["Query"]; ?><br />
		</p>
</div>
<div class="col-sm-4">
								<h2>Get Connected</h2>
								...
								<h2>Contact:</h2>
								<p>Tel: 051 354 687</p>
								<p>Email: <a href="#">mmaw@gmail.com</a><p>
								</br>
