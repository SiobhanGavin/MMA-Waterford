...
<html lang="en">
  <head>
    ...
    <title>MMA Waterford - Log In</title>
		...
		<div class="jumbotron">
			<div class="container text-center">
				...
				<div class="row" >
					...
					<form name="form1" method="post" action="checklogin.php" onsubmit="return(validateForm());" novalidate>
		Username<input name="myusername" type="text" id="myusername" required autofocus></br></br>
		Password<input name="mypassword" type="password" id="mypassword" required></br></br>
		<button class="btn btn-lg btn-primary btn-primary" type="submit">Login</button>
