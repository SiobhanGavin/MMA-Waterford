...
<html lang="en">
  <head>
    ...
    <title>MAA Waterford - edit booking</title>
...
<?php include 'nav.php'; ?>
	...
	<div class="panel panel-default">
	  ...
	  <label for="oldClass">Original Class Selected:</label>
	 ...
	 while($row = $result->fetch_assoc())
	  {
		  echo "<input type='text' name='oldClass'
	  ...
	  <label for="selectClass">Select Different Class;</label>
	  <select class="form-control" id="selectClass" name="selectClass">
	  
	  <?php include 'connect.php';
	  
	  $sql = "SELECT class_id, Class, Day, Time, Coach FROM classes";
